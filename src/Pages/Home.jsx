...
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "HTML5", "CSS", "Typescript", "Figma", "GraphQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/VarshaShaju" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/varshashaju5106711b0" },
  { icon: Instagram, link: "https://www.instagram.com/varsha__shaju_?igsh=MTl0YWVhY3ZscGFicQ%3D%3D&utm_source=qr" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/c6c32e3d-9adb-4c82-909e-df698f954d6f/Jec0IRDwnN.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
